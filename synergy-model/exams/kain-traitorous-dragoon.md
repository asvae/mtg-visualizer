...
```json
{
  "nodes": {
    ...
    "node:jump": {
      ...
      "to": "bf",
      "thing": "self",
      "flags": "cond:your_turn;grant=flying"
    },
    "node:onDealsDamage": {
      "role": "trigger",
      ...
      "to": "stack",
      "thing": "self",
      "flags": "combat player:=damagedPlayer damage:=damageDealt"
    },
    "node:controlChange": {
      "role": "becomes",
      "owner": "any",
