...
// tracked in archive/synergy-model/exams/blb-success.json, updated as the examiner
...
const successCards: string[] = JSON.parse(readFileSync(join(process.cwd(), 'archive/synergy-model/exams/blb-success.json'), 'utf8'));
