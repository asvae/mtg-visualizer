...
// tagging/type_themes.json is the same id -> label list, persisted for reference (so
// an agent tagging a card can look up what creature-type ids already exist) — not
// read here, this module derives labels itself straight from type_line. Dev-only,
