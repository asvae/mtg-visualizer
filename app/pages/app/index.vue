...
<template>
  ...
  <div class="flex min-h-0 min-w-0 flex-1">
    ...
    <!-- PRD 02 "Navigation" — mounted ONLY here (the graph page) and
         ...
         own route (app/pages/app/card/[set]/[number].vue): that's what
         actually guarantees a direct visit to /app/card/[set]/[number]
         never shows this, whatever `?card=` happens to be in the URL at
         the time. -->
    <CardPeekPanel />
  </div>
</template>
