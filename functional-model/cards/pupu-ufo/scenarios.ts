...
export const scenarios: Scenario[] = [
  { result: 'no land-typed hand filler exists in this model to match (see definition.ts), so nothing is put onto the battlefield', ability: 'landDrop', you: { handCount: 1 } },
