...
export function runEngineScenarios(): TraceResult[] {
  ...
  const result =
    'Al Bhed Salvagers is cast, enters the battlefield, then attacks and is lethally blocked by Hill Gigas (a genuine, one-sided 704.5g death). Its own "whenever this creature or another creature or artifact you control dies" trigger fires off its own death: target opponent loses 1 life, you gain 1 life.';
