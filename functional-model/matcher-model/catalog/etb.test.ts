// Unit tests for the `etb` matcher catalog entry — see
...
import { matchesConsumerTriggerNames, matchesConsumerTriggerOn, matchQuery } from '../match-query';
import { entry, query } from './etb';

describe('etb matcher catalog entry (mocked CardDefinition fixtures)', () => {
