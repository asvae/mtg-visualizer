...
1.0    sink      me   bf     --     creature               not:self
1.0    sink      me   bf     --     artifact               not:self
1.1    modifier  me   --     bf     self                   if:1.0 cond:delta=+1/+1counter
1.2    becomes   me   --     bf     self                   if:1.0 lifetime:turn cond:type=artifact-creature
1.3    tagger    me   --     bf     self                   if:1.0 lifetime:turn cond:tag=Spirit
```
