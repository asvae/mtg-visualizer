...
```json
{
  "nodes": {
    ...
    "E": {
      ...
      "to": "--",
      "thing": "self",
      "flags": "cost:{2}{R} cond:class_level=2"
    },
    "F": {
      "role": "trigger",
      "trigger-type": "phase",
    ...
    "G": {
      ...
      "to": "bf",
      "thing": "equipment",
      "flags": "target lifetime:turn cond:"
    },
    "H": {
      "role": "becomes",
      "owner": "me",
      ...
      "to": "--",
      "thing": "self",
      "flags": "cost:{3}{R} cond:class_level=3"
    },
    "I": {
      "role": "modifier",
      "owner": "me",
      ...
      "to": "bf",
      "thing": "creature",
      "flags": "cond:grant=double_strike;grant=haste"
    }
  },
  "flow": {
    "roots": [
